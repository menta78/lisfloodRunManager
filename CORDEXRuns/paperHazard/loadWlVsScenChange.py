...
def getWlEnsemble(ncdir='/ClimateRun4/multi-hazard/eva', bslnYear=1995, retPer=100, warmingLev=2, wlOffset=0):
  flpattern = 'projection_dis_{scen}_{mdl}_wuChang_statistics.nc'
  ...
  ensembleRelChngR8 = np.nanmean(rl_r8, 0)
  ensembleRelChngR4 = np.nanmean(rl_r4, 0)
  ensembleRelChngAll = np.nanmean(rl_all, 0)

  return ensembleRelChngR8, ensembleRelChngR4, ensembleRelChngAll
