...
def doPlotChanges(ax, warmingLev, meanTot, stdDevTot, r8spmean, r4spmean, r8mean, r4mean, plotXLabel, plotYLabel):
...
def plotTimeSerieVariabilityAtWl_hiLowExt_bothWarmLev():
  ...
  plt.annotate('a: aggr. $\Delta Q_{H100}$ at $1.5^\circ$ C', xy=txtpos, xycoords='data', xytext=txtpos, textcoords='data', fontsize=13)
  plt.axes(ax1)
  ...
  plt.annotate('c: aggr. $\Delta Q_M$ at $1.5^\circ$ C', xy=txtpos, xycoords='data', xytext=txtpos, textcoords='data', fontsize=13)
  plt.axes(ax2)
  ...
  plt.annotate('e: aggr. $\Delta Q_{L15}$ at $1.5^\circ$ C', xy=txtpos, xycoords='data', xytext=txtpos, textcoords='data', fontsize=13)
  plt.axes(ax3)
  ...
  plt.annotate('b: aggr. $\Delta Q_{H100}$ at $2.0^\circ$ C', xy=txtpos, xycoords='data', xytext=txtpos, textcoords='data', fontsize=13)
  plt.axes(ax4)
  ylm = plt.ylim([-2, 45]) if positiveChanges else plt.ylim([-25, 10])
  ...
  plt.annotate('d: aggr. $\Delta Q_M$ at $2.0^\circ$ C', xy=txtpos, xycoords='data', xytext=txtpos, textcoords='data', fontsize=13)
  plt.axes(ax5)
  ylm = plt.ylim([-2, 50]) if positiveChanges else plt.ylim([-30, 15])
  ...
  plt.annotate('f: aggr. $\Delta Q_{L15}$ at $2.0^\circ$ C', xy=txtpos, xycoords='data', xytext=txtpos, textcoords='data', fontsize=13)
  plt.axes(ax5)
  ylm = plt.ylim([-15, 90]) if positiveChanges else plt.ylim([-45, 15])

  plt.tight_layout(w_pad=-6.3)
