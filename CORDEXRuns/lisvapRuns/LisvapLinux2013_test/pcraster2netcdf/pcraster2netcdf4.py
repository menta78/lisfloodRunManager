...
__MAP2ASC_CMD = '/eos/jeodpp/data/projects/CRITECH/ADAPTATION/usr/anaconda_LISFLOOD/bin/map2asc'
__TEMP_FILE_SUFIX = '_temp.txt'
__TEMP_BASE_DIR = '/dev/shm'
...
def main(argv):
    ...
    if len(argv) == 4:
        ...
        if var_name in __meteo_vars_config:
            ...
            tempfilename = os.path.join(__TEMP_BASE_DIR, var_name+__TEMP_FILE_SUFIX)
